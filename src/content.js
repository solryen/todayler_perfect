export const APP_STORE_URL = 'https://apps.apple.com/us/app/todayler/id6761668150'
export const CONTACT_EMAIL = 'todaylerapp@gmail.com'

export const HOME_META = {
  title: 'Todayler, Know exactly what to do with your baby today',
  description:
    'Daily age based activities, simple tracking, and calm guidance for parents of babies 0 to 24 months.',
}

export const LEGAL_META = {
  'Privacy Policy': {
    title: 'Todayler, Privacy Policy',
    description: 'Privacy information for Todayler parents and caregivers.',
  },
  'Terms of Service': {
    title: 'Todayler, Terms of Service',
    description: 'Terms of Service for Todayler subscriptions and usage.',
  },
}

export const HERO_CONTENT = {
  title: 'Know exactly what to do with your baby today',
  description:
  ...
  finePrint: 'Free trial. Cancel anytime.',
}

export const FAST_VALUE_STRIP = {
  title: 'When you open Todayler, you instantly:',
  bullets: [
...
export const BEFORE_AFTER_CONTENT = {
  eyebrow: 'WHY PARENTS OPEN IT',
  before: {
    label: 'Before',
    title: 'Too much advice. No clarity.',
    body: "You're tired and still trying to figure out what matters today.",
  },
  after: {
    label: 'With Todayler',
    title: 'One calm place for today.',
    body: 'Open the app and follow what actually helps your baby right now.',
  },
}

export const RELIEF_SECTION = {
  title: 'Why parents keep opening Todayler',
  intro: '',
  cards: [
    {
      icon: 'relief',
      title: 'When you feel behind',
      body: 'You get one clear next step.',
    },
    {
      icon: 'rest',
      title: "When you're exhausted",
      body: 'No research, just guidance.',
    },
    {
      icon: 'support',
      title: 'When you need reassurance',
      body: 'Calm support, not pressure.',
    },
  ],
}
...
export const TODAY_SECTION = {
  ...
  title: 'What happens when you open Todayler',
  intro: '',
  steps: [
    {
      number: '01',
      title: 'See today\'s plan',
      body: "Three simple activities based on your baby's exact age.",
    },
    {
      number: '02',
      title: 'Track without overthinking',
      body: 'Feeds, sleep, milestones, and small wins, without pressure.',
    },
    {
      number: '03',
      title: 'Get help instantly',
      body: 'Ask Mia when you are unsure, and end the day with something calm.',
    },
  ],
  cta: 'See today\'s flow',
}

export const TRUST_SECTION = {
  eyebrow: 'WHY IT FEELS DIFFERENT',
  title: 'Built for real days, not perfect ones',
  intro:
...
export const TESTIMONIALS = [
  {
    name: 'Sarah',
    profile: 'Mom of 3, with a toddler',
    text: 'It makes the day feel easier instead of louder.',
  },
  {
    name: 'James',
    profile: 'Dad of a toddler',
    text: 'I open it tired and it tells me what helps today.',
  },
  {
    name: 'Emily',
    profile: 'First time mom',
    text: 'It feels supportive, not like another thing to manage.',
  },
]

export const FAQS = [
  {
    question: 'Will this overwhelm me?',
    answer:
      'No. It narrows the day down to what matters now.',
  },
  {
    question: 'What if I\'m already exhausted?',
    answer:
...
export const PRICING_CONTENT = {
  ...
  subtitle: 'Try Todayler free and see how it fits your day.',
  price: '',
  priceSuffix: '',
  billingNote: '',
  features: [
...
export const FINAL_CTA = {
  title: 'Start with one calmer day',
  body: 'Know what to do today, then take it one simple step at a time.',
  cta: 'Start your free trial',
}

export const PRIVACY_LAST_UPDATED = 'March 14, 2026'
...
export const PRIVACY_SECTIONS = [
  ...
  {
    heading: '12. Subscriptions and Payments',
    paragraphs: [
  ...
  },
  {
    heading: '15. Contact',
    paragraphs: [
      'If you have privacy questions or requests, contact us at todaylerapp@gmail.com.',
    ],
  },
]

export const TERMS_LAST_UPDATED = 'March 14, 2026'
...
export const TERMS_SECTIONS = [
  ...
  {
    heading: '6. AI Feature Disclaimer',
    paragraphs: [
  ...
  },
  {
    heading: '16. Contact',
    paragraphs: [
      'Questions about these Terms can be sent to todaylerapp@gmail.com.',
    ],
  },
  {
    heading: '17. Apple Standard EULA',
    paragraphs: [
      "Todayler uses Apple's Standard End User License Agreement (EULA).",
    ],
    link: {
