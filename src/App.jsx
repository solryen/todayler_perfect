...
import sarahProfileImage from './assets/sarahprofile.jpg'
import jamesProfileImage from './assets/jamesprofile.jpg'
import emilyProfileImage from './assets/emilyprofile.jpg'
import {
  APP_STORE_URL,
...
const testimonialImages = {
  Sarah: sarahProfileImage,
  James: jamesProfileImage,
  Emily: emilyProfileImage,
}
      ...
      <PageShell>
        <div className="site-header-inner">
          ...
          <StoreButton location="header-cta">
            <span className="desktop-label">Download now</span>
            <span className="mobile-label">Download</span>
          </StoreButton>
        </div>
      </PageShell>
    </header>
            ...
            >
              <div className="testimonial-profile">
                ...
                <div className="testimonial-meta">
                  ...
                  <p className="testimonial-role">{testimonial.profile}</p>
                </div>
              </div>
          ...
          <Reveal as="article" className="pricing-card reveal reveal-fade-up-soft" delay={120}>
            {PRICING_CONTENT.price ? (
              <p className="price-line">
                {PRICING_CONTENT.price}
                {PRICING_CONTENT.priceSuffix ? <span>{PRICING_CONTENT.priceSuffix}</span> : null}
              </p>
            ) : null}
            {PRICING_CONTENT.billingNote ? (
    ...
    <footer className="site-footer">
      <PageShell className="footer-layout">
        <div className="footer-brand">
          ...
          <p className="footer-tagline">Daily relief for parents of babies 0 to 24 months.</p>
        </div>
